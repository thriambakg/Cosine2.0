# Fix ALB Health Check Settings - Updated to match Terraform
param(
...
# These settings are optimized for Next.js startup times and response patterns
...
Write-Host ""
Write-Host "⏱️ Expected Timings:" -ForegroundColor Yellow
Write-Host "• Time to mark unhealthy: 3 failures × 30s = 90 seconds" -ForegroundColor White
Write-Host "• Time to mark healthy: 2 successes × 30s = 60 seconds" -ForegroundColor White
