...
export default function AppSidebar() {
  ...
  const { isRobinhoodConnected } = useAppSelector((state) => state.portfolio);
      ...
      <Box key={category} sx={{ mb: 2 }}>
        ...
        <List sx={{ px: 2 }}>
          {items.map((item) => {
            ...
            // Show connection status for Robinhood
            const showConnectionBadge = item.id === 'robinhood' && isRobinhoodConnected;
              ...
              <ListItem key={item.id} disablePadding sx={{ mb: 0.5 }}>
                <ListItemButton
                  ...
                  sx={{
                    borderRadius: 2,
                    mx: 0.5,
                    background: isActive ? theme.customColors.primary.gradient : 'transparent',
