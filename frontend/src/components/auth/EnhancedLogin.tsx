// Enhanced Login Component with Third-Party Authentication
...
export const EnhancedLogin: React.FC<LoginProps> = ({ onLoginSuccess, onLoginError }) => {
  ...
  const handleFederatedLogin = async (provider: 'Google') => {
    try {
      ...
      onLoginError(error.message || `${provider} login failed`);
      setLoading(false);
    }
  };
      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-xl shadow-lg">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex justify-center items-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50"
          >
