...
if (Test-Path "local_dev\scripts\setup_simple.ps1") {
    & ".\local_dev\scripts\setup_simple.ps1"
} else {
    Write-Host "ERROR: local_dev\scripts\setup_simple.ps1 not found. Please run from the project root directory." -ForegroundColor Red
    exit 1
}
...
Write-Host "   python local_dev\backend\local_server.py" -ForegroundColor White
...
Write-Host "   local_dev\LOCAL_DEVELOPMENT_GUIDE.md" -ForegroundColor White
