...
python local_dev\backend\local_server.py
```
...
# Then navigate to frontend and start the development server
cd frontend\app
npm run dev
```
...
├── frontend/
│   └── (frontend-specific files if any)
├── scripts/
│   ├── setup_simple.ps1          # Backend setup script
│   ├── setup_full_local.ps1      # Complete setup script
│   ├── setup_frontend_simple.ps1 # Frontend setup script
...
backend_app/
└── src/stocks/robinhood_integration/  # Backend source code
```
...
2. **Backend not responding**
   - Make sure `python local_dev\backend\local_server.py` is running
