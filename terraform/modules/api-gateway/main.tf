...
resource "aws_api_gateway_resource" "this" {
  ...
  rest_api_id = aws_api_gateway_rest_api.this.id
  # Use parent resource if parent_path is specified, otherwise use root
  parent_id = lookup(each.value, "parent_path", null) != null ? aws_api_gateway_resource.this[each.value.parent_path].id : aws_api_gateway_rest_api.this.root_resource_id
