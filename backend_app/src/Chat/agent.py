...
6. IMPORTANT: When using file return tools, include the JSON data from the tool in your response
7. The tools return JSON strings with file_data - include this JSON in your response for proper file display
