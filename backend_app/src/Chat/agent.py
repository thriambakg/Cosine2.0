...
- Roll call search returns enriched_results[] (display-ready rows with bill_title, roll_date, vote_type, vote_question, result_display, congress, session, roll). Prefer enriched_results over results when presenting to the user.
