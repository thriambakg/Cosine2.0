...
def lambda_handler(event, context):
    ...
    job_id = None
    request_id = None
    completion_sns_topic = os.environ.get('STOCK_SCREENER_COMPLETION_SNS_TOPIC_ARN')
    ...
    try:
        ...
        try:
            ...
            if is_sqs_event and job_id and completion_sns_topic:
                try:
                    ...
                    sns_client.publish(
                        ...
                        Subject=f'Stock Screener Completion: {job_id}',
                        MessageAttributes={
                            'request_id': {
                                'DataType': 'String',
            ...
            if is_sqs_event and job_id and completion_sns_topic:
                try:
                    ...
                    sns_client.publish(
                        ...
                        Subject=f'Stock Screener Failure: {job_id}',
                        MessageAttributes={
                            'request_id': {
                                'DataType': 'String',
                                'StringValue': request_id
            ...
            if is_sqs_event:
                return {
                    'statusCode': 500,
                    'body': json.dumps({'message': 'Screening failed', 'job_id': job_id, 'error': str(screening_error)})
                }
